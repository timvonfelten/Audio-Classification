...
directory_path = "/Users/timvonfelten/LocalStorage/Audio-Classification_seth/raw_audio/ost_01_u"
...
def process_file(filename):
    ...
    for i in range(0, clean_wav.shape[0] - window + 1, step):
        ...
        for model_name, model in models.items():
            ...
            # Runden der Confidence-Werte auf 2 Nachkommastellen
            confidence_rounded = round(y_mean[predicted_label], 2)
            #print(confidence_rounded)
            results[model_name] = {
